...
/*項目名*/
const T_DISPLAY MODE_NAME[MODE_NUM]										= {"電子オルガンモード","自動演奏モード","ゲームモード","タイマモード","設定",};//モード名
...
const unsigned char SELECTABLE_TITLE_ARREY[SELECT_PLAY_TITLE_NUM]				= {AVE_MARIA,SAINT_MARCH,JESU_JOY_OF_MAN_S,MENUETT,CANON,DORAGON_QUEST,BATTLE1,WINNING,ZENNMETU};//この配列に入っている曲がメニューに表示され選択できる
